  ...
  return (
    <main className="container mx-auto mt-10 p-4">
      ...
      <section className="mt-16">
        <h3 className="text-2xl font-bold mb-4 text-center">주요 기능</h3>
        <ul className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <li className="bg-white p-6 rounded shadow dark:bg-gray-800">
            <section>
              <h4 className="text-xl font-bold mb-2">정보 공유</h4>
          ...
          <li className="bg-white p-6 rounded shadow dark:bg-gray-800">
            <section>
              <h4 className="text-xl font-bold mb-2">자유 게시판</h4>
          ...
          <li className="bg-white p-6 rounded shadow dark:bg-gray-800">
            <section>
              <h4 className="text-xl font-bold mb-2">질문 게시판</h4>
